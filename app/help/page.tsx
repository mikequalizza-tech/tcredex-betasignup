...
const featureSections: FeatureSection[] = [
  {
    ...
    articles: [
      ...
      { title: "How Intake Drives the System", href: "/help/how-intake-drives-system" },
          ...
          <div className="py-12 md:py-16 lg:py-20">
            ...
            <div className="mb-12 md:mb-16">
              ...
              <p className="text-lg text-indigo-200/65 max-w-2xl">
                Everything you need to know about using tCredex to navigate tax credit financing.
            ...
            {/* Quick Links Grid */}
            <div className="mb-16">
              <h2 className="text-lg font-semibold text-gray-200 mb-6">Popular Topics</h2>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                  ...
                  <p className="text-gray-400">
                    Can&apos;t find what you&apos;re looking for? Ask ChatTC or join our beta.
                  </p>
                </div>
