export const metadata = {
  ...
  description:
    "Learn about Brownfield Tax Credits for cleanup and redevelopment of contaminated properties. Available through state and local programs.",
};
          ...
          <div className="py-12 md:py-20">
            ...
            <div className="bg-teal-900/30 border border-teal-500/50 rounded-2xl p-8 mb-12">
              ...
              <p className="text-gray-300 mb-4">
                The EPA defines a brownfield as &quot;a property, the expansion,
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="border border-gray-700 rounded-xl p-5">
                  ...
                  <p className="text-gray-400 text-sm">
                    Many states offer tax credits for qualified cleanup costs,
                    often ranging from 25-100% of eligible expenses.
                  </p>
                </div>
                <div className="border border-gray-700 rounded-xl p-5">
                  <h3 className="text-lg font-semibold text-teal-400 mb-2">
                  ...
                  <p className="text-gray-400 text-sm">
                    IRC Section 198 allows immediate deduction of environmental
                    remediation costs for qualified contaminated sites.
                  </p>
                </div>
                <div className="border border-gray-700 rounded-xl p-5">
                  <h3 className="text-lg font-semibold text-teal-400 mb-2">
                  ...
                  <p className="text-gray-400 text-sm">
                    Brownfields Assessment, Cleanup, and Revolving Loan Fund
                    grants available through EPA programs.
                  </p>
                </div>
                <div className="border border-gray-700 rounded-xl p-5">
                  <h3 className="text-lg font-semibold text-teal-400 mb-2">
                  ...
                  <p className="text-gray-400 text-sm">
                    Voluntary Cleanup Programs provide liability protection and
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 mb-12">
              ...
              <p className="text-gray-300">
                Brownfield incentives can often be combined with other tax
                credit programs. A contaminated site in an Opportunity Zone that
                also qualifies for NMTC can leverage multiple incentive layers
                to make challenging redevelopment projects financially viable.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-6">
                Check what incentives are available and find development
                partners.
              </p>
