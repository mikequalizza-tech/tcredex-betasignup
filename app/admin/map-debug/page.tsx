  ...
  const testEligibility = async (debug = true) => {
    ...
    try {
      const response = await fetch(
        `/api/eligibility?tract=${tractId}&debug=${debug}`,
      );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {result && (
          <div className="bg-gray-800 rounded-lg p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
              Results
              {result.eligible ? (
                <span className="text-green-400 text-sm px-2 py-1 bg-green-900/50 rounded">
                  ✓ ELIGIBLE
                </span>
              ) : (
                <span className="text-red-400 text-sm px-2 py-1 bg-red-900/50 rounded">
                  ✗ NOT ELIGIBLE
                </span>
              )}
            </h2>
              ...
              <div className="mb-6 p-4 bg-yellow-900/30 border border-yellow-700 rounded">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p
                      className={
                        result.tractFound ? "text-green-400" : "text-red-400"
                      }
                    >
        ...
        <div className="mt-8 text-sm text-gray-500">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Table Row Count = 0:</strong> Data not imported to
              Supabase
            </li>
            <li>
              <strong>Tract Found = No:</strong> GEOID format mismatch (leading
              zeros issue)
            </li>
            <li>
              <strong>is_nmtc_lic = null:</strong> Column missing or wrong name
              in database
            </li>
            <li>
              <strong>is_nmtc_lic = &quot;NO&quot;:</strong> Tract exists but
              not NMTC eligible
            </li>
            <li>
              <strong>
                is_nmtc_lic = &quot;YES&quot; but eligible = false:
              </strong>{" "}
