    ...
    <div className="flex-1 bg-gray-950">
      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <Link href="/deals" className="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-4 text-sm">
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                {investor.activelyInvesting ? (
                  <span className="px-3 py-1 bg-green-900/30 text-green-300 border border-green-500/30 rounded-full text-sm">Actively Investing</span>
                ) : (
                  <span className="px-3 py-1 bg-gray-800 text-gray-400 border border-gray-700 rounded-full text-sm">Not Currently Active</span>
                )}
              </div>
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-1">{investor.name}</h1>
