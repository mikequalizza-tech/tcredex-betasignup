...
function NewDocumentPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(
        `/dashboard/documents/upload?documentId=${mockId}&entityType=${entityType}&entityId=${entityId}`,
      );
    } catch (error) {
  ...
  const _getEntityName = () => {
    if (!entityId || entityType === "user") return "";
    const entities =
      demoEntities[entityType as keyof typeof demoEntities] || [];
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                {demoEntities[entityType as keyof typeof demoEntities]?.map(
                  (entity) => (
          ...
          <label className="flex items-center gap-3 cursor-pointer p-3 bg-gray-800 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Mark this document as required to complete the transaction
              </p>
            </div>
          </label>
