...
export default function SettingsPage() {
  const { orgType: _orgType, isAuthenticated, isLoading, userName, userEmail, orgName, user } = useCurrentUser();
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Edit organization name in <a href="/dashboard/teams" className="text-indigo-400 hover:text-indigo-300">Team Settings</a>
                  </p>
                </div>
                <div>
