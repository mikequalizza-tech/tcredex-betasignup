...
export default function EditDealPage() {
    ...
    async function fetchDeal() {
      ...
      try {
        ...
        const intakeData: Partial<IntakeData> = {
          ...
          projectName: intakeFromDb.projectName || data.project_name || data.name,
          ...
          totalProjectCost: intakeFromDb.totalProjectCost || data.total_project_cost,
          programs: intakeFromDb.programs || data.programs || [],
          projectDescription: intakeFromDb.projectDescription || data.project_description,
          sponsorName:
  ...
  const handleSave = async (data: IntakeData, _readinessScore: number, _tier: number) => {
  ...
  const handleSubmit = async (data: IntakeData, _readinessScore: number, _tier: number) => {
    const sponsorId = organizationId || user?.id;
    if (!sponsorId) {
