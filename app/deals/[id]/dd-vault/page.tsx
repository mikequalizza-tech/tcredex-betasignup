...
export default function DDVaultPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function loadData() {
    ...
    try {
      ...
      const vaultResult = await fetchApi<{ data: DDDocument[]; summary: DDVaultSummary }>(
  ...
  async function initializeVault() {
    ...
    try {
      ...
      if (programs.length === 0) {
        programs = ['NMTC'];
        console.warn('[DD Vault] No programs found on deal, defaulting to NMTC');
      }
      ...
      if (result.success) {
        ...
        const recheckResult = await fetchApi<{ data: DDDocument[]; summary: DDVaultSummary }>(
          `/api/dd-vault?dealId=${dealId}&includeSummary=true`
        );
        if (!recheckResult.data?.data?.length) {
          setError('DD Vault records exist but cannot be loaded. Try "Reset Vault" below.');
        }
      } else {
  ...
  async function resetVault() {
    if (!confirm('This will delete all DD vault entries for this deal. The vault can be re-initialized after. Continue?')) {
      return;
    }
      ...
      <div className="min-h-screen bg-gray-950 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Due Diligence Vault</h1>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 text-center max-w-lg mx-auto">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">DD Vault Not Initialized</h2>
            <p className="text-gray-400 mb-6">
              Initialize the due diligence vault to track all required documents for this deal.
              Document requirements are based on the selected programs.
            </p>
        ...
        {summary && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-emerald-400">{summary.greenCount}</p>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-amber-400">{summary.yellowCount}</p>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-rose-400">{summary.redCount}</p>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 mb-8">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold text-white">
                {summary.requiredComplete} / {summary.requiredTotal} ({summary.completionPercentage}%)
              </span>
            </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`text-sm font-medium ${statusTextColors[statusColor]}`}>
