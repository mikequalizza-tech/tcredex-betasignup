...
const sampleCDE: CDEDealCard & {
  ...
  missionSnippet: 'Dedicated to financing community facilities, healthcare, and economic development in underserved urban and rural communities across the Midwest.',
  ...
  impactPriorities: ['job-creation', 'healthcare-access', 'community-services', 'rural-development'],
...
const sampleCDE2: CDEDealCard & {
  ...
  missionSnippet: 'Supporting economic revitalization in hurricane-impacted communities through targeted investments in small business and workforce development.',
  remainingAllocation: 18000000,
  totalAllocation: 50000000,
  allocationType: 'Federal',
  allocationDeadline: '2026-06-30',
  primaryStates: ['TX', 'LA', 'MS', 'AL', 'FL'],
  targetSectors: ['Small Business', 'Workforce Development', 'Retail', 'Food Access'],
  impactPriorities: ['small-business-support', 'job-creation', 'food-access', 'minority-owned-business'],
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Preview of the CDECard component with all matchable fields from cdes_merged</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Without match score */}
          <div>
            <p className="text-sm text-gray-400 mb-2">No Match Score (Browse mode)</p>
            <CDECard cde={{ ...sampleCDE, matchScore: undefined, matchReasons: undefined } as CDEDealCard} />
          </div>
        </div>
        ...
        <div className="mt-12 p-4 bg-gray-900 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-300">
            ...
            <div>
              <h3 className="text-indigo-400 font-medium mb-2">Deal Preferences</h3>
              <ul className="space-y-1 text-gray-400">
            ...
            <div>
              <h3 className="text-indigo-400 font-medium mb-2">Focus & Experience</h3>
              <ul className="space-y-1 text-gray-400">
