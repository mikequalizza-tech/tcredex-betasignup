...
const sampleInvestor1: InvestorCardType = {
  ...
  targetSectors: ['Healthcare', 'Community Facilities', 'Manufacturing', 'Mixed-Use'],
  totalInvestments: 45,
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold text-white mb-2">Investor Card Preview</h1>
        <p className="text-gray-400 mb-8">Preview of the InvestorCard component for AutoMatch funnel</p>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* High match score - Bank CRA motivated */}
          <div>
            <p className="text-sm text-green-400 mb-2">High Match (92%) - CRA Motivated Bank</p>
            <InvestorCard investor={sampleInvestor1} />
          </div>

          {/* Medium match score - Insurance company */}
          <div>
            <p className="text-sm text-amber-400 mb-2">Medium Match (75%) - Insurance Company</p>
            <InvestorCard investor={sampleInvestor2} />
          </div>

          {/* No match score - CDFI Browse mode */}
          <div>
            <p className="text-sm text-gray-400 mb-2">No Match Score (Browse) - CDFI</p>
            <InvestorCard investor={sampleInvestor3} />
          </div>
        </div>

        <div className="mt-12 p-4 bg-gray-900 rounded-lg">
          <h2 className="text-lg font-semibold text-white mb-4">Fields Displayed</h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-300">
            ...
            <div>
              <h3 className="text-indigo-400 font-medium mb-2">Investment Capacity</h3>
              <ul className="space-y-1 text-gray-400">
            ...
            <div>
              <h3 className="text-indigo-400 font-medium mb-2">Target Preferences</h3>
              <ul className="space-y-1 text-gray-400">
        ...
        <div className="mt-8 p-4 bg-indigo-900/20 border border-indigo-500/30 rounded-lg">
          <h2 className="text-lg font-semibold text-indigo-300 mb-2">AutoMatch Relevance</h2>
          <p className="text-gray-300 text-sm">
            The InvestorCard displays all fields needed for AI AutoMatch to connect deals with capital sources:
          </p>
          <ul className="mt-2 space-y-1 text-sm text-gray-400">
            <li>• <span className="text-green-400">CRA Motivation</span> - Banks seeking CRA credit match with eligible census tracts</li>
            <li>• <span className="text-emerald-400">Target Programs</span> - Match investor program preferences with deal program types</li>
            <li>• <span className="text-blue-400">Geographic Alignment</span> - Target states match with project location</li>
            <li>• <span className="text-purple-400">Sector Match</span> - Target sectors align with project type</li>
            <li>• <span className="text-amber-400">Investment Capacity</span> - Deal size fits within min/max range</li>
          </ul>
        </div>
      </div>
    </main>
