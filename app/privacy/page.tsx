export const metadata = {
  ...
  description:
    "tCredex Privacy Policy - How we collect, use, and protect your information.",
};
          ...
          <div className="py-12 md:py-20">
            ...
            <div className="bg-indigo-900/20 border border-indigo-500/30 rounded-2xl p-8 mb-8">
              <p className="text-gray-300">
                tCredex respects the confidentiality and security of user
            ...
            <div className="space-y-6">
              ...
              <div className="bg-green-900/20 border border-green-500/30 rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-4">
                  <strong className="text-green-400">
                    tCredex does not sell personal data.
                  </strong>
                </p>
                <p className="text-gray-300">
                  Data may be shared with trusted service providers solely to
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
                ...
                <p className="text-gray-300">
                  tCredex employs commercially reasonable safeguards to protect
                  information.
                </p>
              </div>
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
                ...
                <p className="text-gray-300">
                  Users are responsible for ensuring they have rights to submit
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8">
                ...
                <p className="text-gray-300">
                  ...
                  <br />
                  <a
                    href="mailto:privacy@tcredex.com"
