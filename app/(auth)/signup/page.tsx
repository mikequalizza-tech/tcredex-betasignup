...
function SignUp() {
  ...
  // Form data
  const [orgType, setOrgType] = useState<OrgType | ''>(isReferral && refType ? refType as OrgType : '');
  ...
  useEffect(() => {
    ...
    fetch(`/api/cdes/lookup?org=${refOrgId}`)
      ...
      .catch(() => { /* org name will just be empty */ })
          ...
          {step === 1 && (
            <div className="mx-auto max-w-[500px]">
              ...
              <div className="mt-8 text-center text-sm text-indigo-200/65">
                ...
                <Link className="font-medium text-indigo-500 hover:text-indigo-400" href={refDealId ? `/signin?redirect=/deals/${refDealId}` : '/signin'}>
                  Sign in
                </Link>
              </div>
            </div>
            ...
            <form className="mx-auto max-w-[500px]" onSubmit={handleSubmit}>
              ...
              {isReferral && refDealId && (
                <div className="p-4 bg-indigo-900/30 border border-indigo-500/30 rounded-lg mb-6">
                  <p className="text-sm text-indigo-300 font-medium">You&apos;ve been invited to review a project on tCredex</p>
                  <p className="text-xs text-indigo-400/70 mt-1">Create your account to view the deal and manage allocation requests.</p>
                </div>
              )}
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder={referralLoading ? 'Loading...' : 'Acme Development Corp'}
                    value={orgName}
                  ...
                  />
                  {isReferral && orgName && (
                    <p className="text-xs text-indigo-400/60 mt-1">Pre-filled from your CDFI Fund allocation record</p>
                  )}
                </div>
