    ...
    <div className="mx-auto max-w-md px-4 py-20">
      <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-8 shadow-xl backdrop-blur-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">AI-Powered Tax Credit Marketplace</p>
        </div>
        ...
        {success ? (
          ...
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-white">Welcome to tCredex!</h2>
          ...
          <div>
            ...
            <form onSubmit={handleCodeSubmit}>
              ...
              {codeError && (
                <p className="mb-4 text-center text-sm text-red-400">{codeError}</p>
              )}
            ...
            <p className="mt-6 text-center text-xs text-gray-500">
              Don&apos;t have a code? <a href="/signup" className="text-indigo-400 hover:underline">Sign up here</a>
            </p>
          </div>
        ) : (
          /* Step 2: Set Password */
          <div>
            <div className="mb-6 rounded-xl border border-indigo-500/30 bg-indigo-500/10 p-4 text-center">
              ...
              <p className="mt-1 text-lg font-bold text-white">{orgInfo.orgName}</p>
              {orgInfo.contactName && (
            ...
            <p className="mb-6 text-center text-sm text-gray-400">
              Create a password for <strong className="text-gray-300">{orgInfo.contactEmail}</strong>
            </p>
            ...
            <form onSubmit={handleActivate}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) => { setConfirmPassword(e.target.value); setActivateError(''); }}
              ...
              {activateError && (
                <p className="mb-4 text-center text-sm text-red-400">{activateError}</p>
              )}
            ...
            <button
              onClick={() => { setOrgInfo(null); setCode(''); setPassword(''); setConfirmPassword(''); }}
