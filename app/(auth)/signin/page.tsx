      ...
      <div className="relative w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-800">
          <div className="flex items-center gap-3 mb-2">
            ...
            />
            <h1 className="text-xl font-semibold text-white">Sign in to tCredex</h1>
          </div>
        ...
        <div className="p-6">
          ...
          {magicLinkSent ? (
            <div className="text-center py-6">
              ...
              <p className="text-xs text-gray-500">Click the link in your email to sign in. It expires in 1 hour.</p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center">
                <button
                  ...
                  className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors"
                >
                  {magicLinkMode ? 'Use password instead' : 'Sign in with magic link (no password)'}
                </button>
              </div>
            </form>
          )}
        ...
        <div className="px-6 py-4 bg-gray-800/50 border-t border-gray-800 space-y-3">
          <p className="text-sm text-center text-gray-400">
            ...
            <Link href={redirectTo !== '/dashboard' ? `/signup?redirect=${encodeURIComponent(redirectTo)}` : '/signup'} className="text-indigo-400 hover:text-indigo-300 font-medium">
              Sign up
            </Link>
          </p>
          ...
          <div className="pt-2 border-t border-gray-700">
            <p className="text-xs text-center text-gray-500">
              ...
              <Link href="/contact" className="text-indigo-400/80 hover:text-indigo-300">
                Contact us
              </Link>
            </p>
          </div>
