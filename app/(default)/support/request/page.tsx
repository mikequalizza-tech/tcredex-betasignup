...
const requestTypes: {
...
}[] = [
  {
    ...
    description: "Bug, error, or platform not working correctly",
  },
  {
    value: "deal",
    label: "Deal Support",
    description: "Questions about a specific deal or matching",
  },
  {
    value: "account",
    label: "Account Help",
    description: "Profile, permissions, or access issues",
  },
  {
    value: "billing",
    label: "Billing Question",
    description: "Invoices, fees, or payment issues",
  },
  {
    value: "feature",
...
const priorityLevels = [
  { value: "low", label: "Low", description: "General question, no urgency" },
  {
    value: "medium",
    label: "Medium",
    description: "Need help soon but not blocking",
  },
  {
    value: "high",
    label: "High",
    description: "Blocking my work, need help today",
  },
  {
    value: "urgent",
    label: "Urgent",
    description: "Critical issue, deal at risk",
  },
];
        ...
        <div className="max-w-2xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">
              Your support ticket has been created. We&apos;ll get back to you
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">
            Tell us how we can help. All users can submit support requests
            regardless of role.
          </p>
        </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            {userRole && (
              <p className="mt-3 text-xs text-gray-500">
                Logged in as <span className="text-indigo-400">{userRole}</span>{" "}
                user
              </p>
            )}
          </div>
