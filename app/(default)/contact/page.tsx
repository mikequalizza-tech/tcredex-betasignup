...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        "Failed to send message. Please email us directly at support@tcredex.com",
      );
    } finally {
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            <div className="pb-12 text-center">
              ...
              <div className="mx-auto max-w-3xl">
                <p className="text-xl text-indigo-200/65">
                  Get help with the tCredex platform - account issues, technical
                  support, and feature questions.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <Link
                href="/contact-aiv"
                className="bg-gray-900 rounded-xl border border-gray-800 p-6 text-center hover:border-indigo-600 transition-colors group"
              >
            ...
            <form
              ...
              className="mx-auto max-w-[640px] bg-gray-900 rounded-xl border border-gray-800 p-8"
            >
