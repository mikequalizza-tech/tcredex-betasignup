...
export default function PricingCoachPage() {
  ...
  const [sponsorExperience, setSponsorExperience] =
    useState<string>("experienced");
  ...
  const calculatePricing = () => {
    ...
    if (tractType === "SD") {
      ...
      adjustedPrice -= 0.01;
      adjustments.push({
        factor: "Low-Income Community (non-QCT)",
        impact: -0.01,
      });
    }
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Get estimated credit pricing based on your deal characteristics
        </p>
      </div>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
            ...
            <div className="mb-4">
              ...
              <p className="mt-2 text-xs text-gray-500">
                {PROGRAM_INFO[program].description}
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={allocation}
                  onChange={(e) =>
                    setAllocation(e.target.value.replace(/[^0-9]/g, ""))
                  }
              ...
              <p className="mt-1 text-xs text-gray-500">
                {parseFloat(allocation)
                  ? formatCurrency(parseFloat(allocation))
                  : "$0"}
              </p>
            </div>
          ...
          {result ? (
            <>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                  ...
                  <div className="text-center p-4 bg-gray-800 rounded-xl">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {PROGRAM_INFO[result.program].creditPercent}% of basis
                    </p>
                  </div>
                  <div className="text-center p-4 bg-gray-800 rounded-xl">
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2 text-sm text-gray-300">
                    <span className="text-indigo-400 mt-1">•</span>
                    This is an estimate only — actual pricing varies by market
                    conditions
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-indigo-900/30 border border-indigo-800 rounded-xl p-6 text-center">
                ...
                <p className="text-gray-400 mb-4">
                  Get matched with CDEs and investors on the tCredex marketplace
                </p>
                <a
                  href="/deals/new"
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-12 text-center">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                Select your tax credit program and enter deal details to get an
                estimated credit price based on current market conditions.
              </p>
            </div>
          )}
        </div>
