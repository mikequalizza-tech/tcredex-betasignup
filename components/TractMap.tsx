      ...
      map.addLayer({
        ...
        paint: {
          "fill-color": [
            ...
            ["get", "stack_count"],
            0,
            "#9E9E9E", // Gray - not eligible
            1,
            "#F4E04D", // Yellow - one program
            2,
            "#F59E0B", // Orange - two programs
            3,
            "#7C3AED", // Purple - triple stack
            "#CCCCCC",
          ],
          "fill-opacity": 0.6,
        },
        ...
        <div className="absolute top-4 left-4 bg-white p-4 rounded shadow w-80">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2">
              <span
                className={
                  selectedTract.nmtc_lic ? "text-green-600" : "text-gray-400"
                }
              >
            ...
            <div className="flex items-center gap-2">
              <span
                className={
                  selectedTract.lihtc_qct ? "text-green-600" : "text-gray-400"
                }
              >
            ...
            <div className="flex items-center gap-2">
              <span
                className={
                  selectedTract.oz ? "text-green-600" : "text-gray-400"
                }
              >
                {selectedTract.oz ? "✓" : "✗"}
              </span>
