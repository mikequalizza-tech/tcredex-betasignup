        ...
        <div className="p-6 border-b border-gray-800 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">
              Review your generated DealCard before submitting to the
              marketplace
            </p>
          </div>
          {onClose && (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium text-white ${tierColors[completeness.tier]}`}
                  >
              ...
              <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        deal.shovelReady ? "text-green-400" : "text-gray-500"
                      }
                    >
                  ...
                  {deal.coordinates && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono text-xs text-gray-300">
                        {deal.coordinates[1].toFixed(4)},{" "}
                        {deal.coordinates[0].toFixed(4)}
                      </span>
                    </div>
                  )}
                </div>
