...
export default function DealCardHTML({ deal }: DealCardHTMLProps) {
  ...
  const totalSources =
    deal.totalSources || sources.reduce((sum, s) => sum + (s.amount || 0), 0);
  const totalUses =
    deal.totalUses || uses.reduce((sum, u) => sum + (u.amount || 0), 0);
  ...
  const styles = {
    ...
    bannerTop: {
      background:
        "linear-gradient(90deg, #1e1b4b 0%, #312e81 50%, #4c51bf 100%)",
      padding: "10px 14px",
      display: "flex",
      ...
      <div style={styles.cardContent}>
        ...
        <div>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <span style={styles.fieldValue}>
                {formatCurrency(deal.stateNMTCAllocation)}
              </span>
            </div>
            <div
              style={{
        ...
        <div>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <span style={{ ...styles.fieldValue, fontSize: "7pt" }}>
                {deal.censusTract || "—"}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <span style={styles.fieldValue}>
                {formatPercent(deal.povertyRate)}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={styles.fieldLabel}>Med Inc</span>
              <span style={styles.fieldValue}>
                {formatPercent(deal.medianIncome)}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={styles.fieldLabel}>Unemp</span>
              <span style={styles.fieldValue}>
                {formatPercent(deal.unemployment)}
              </span>
            </div>
          </div>
        </div>
        ...
        <div style={styles.cardFooter}>
          <div style={styles.contactInfo}>
            ...
            tcredex.com
            <br />
            <a href="mailto:Info@tCredex.com" style={styles.contactLink}>
              Info@tCredex.com
            </a>
          </div>
          <TreeBuildingLogo />
