        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-indigo-200/65">
              ...
              an opportunity to transform how community development deals get
              done.
            </p>
          </div>
          {/* Items */}
          ...
          >
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-[1rem] text-indigo-200/65">
                  With 20+ years in NMTC transactions, our founding team
                  recognized that community development projects were struggling
                  to find the right CDEs, while CDEs were spending months
                  sourcing quality deals. The matching process was broken.
                </p>
              </div>
            </div>
            {/* 2nd item */}
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-[1rem] text-indigo-200/65">
                  We ingested 33,000+ pages of CDFI Fund data, CDE intake forms,
                  and historical allocation patterns. Our AI-powered matching
                  engine was trained to understand what makes a successful NMTC
                  transaction.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-[1rem] text-indigo-200/65">
                  ...
                  AI-powered CDE matching, tCredex opens to sponsors and CDEs
                  nationwide.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pl-2">
                ...
                <p className="text-[1rem] text-indigo-200/65">
                  Our goal: facilitate $1B+ in tax credit transactions that
                  create jobs, build healthcare facilities, revitalize historic
                  buildings, and bring opportunity to the communities that need
                  it most.
                </p>
              </div>
            </div>
