...
export function CapitalStack({ data, onChange }: CapitalStackProps) {
  ...
  const totalSources =
    ...
    (data.otherAmount || 0);
  const committedPct =
    data.totalProjectCost && data.totalProjectCost > 0
  ...
  const handleSourceChange = (
    ...
    const newTotal =
      newValues.equityAmount +
      newValues.debtAmount +
      newValues.grantAmount +
      newValues.otherAmount;
    const newPct =
      data.totalProjectCost && data.totalProjectCost > 0
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-gray-400">
        Identify your capital sources. This affects your readiness score and
        helps CDEs/Investors understand your financing position.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Owner/sponsor equity contribution
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                handleSourceChange("debtAmount", parseCurrency(e.target.value))
              }
              placeholder="0"
              className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
          ...
          <p className="text-xs text-gray-500 mt-1">
            Bank loan or other senior debt
          </p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                handleSourceChange("grantAmount", parseCurrency(e.target.value))
              }
              placeholder="0"
              className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                handleSourceChange("otherAmount", parseCurrency(e.target.value))
              }
              placeholder="0"
              className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
      ...
      <div className="border-t border-gray-800 pt-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-700">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-100">
                $
                {formatCurrency(
                  Math.max(0, (data.totalProjectCost || 0) - totalSources),
                )}
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 text-xs text-gray-500">
          <p className="flex items-center gap-2">
            <span
              className={`w-3 h-3 rounded-full ${committedPct >= 80 ? "bg-green-500" : "bg-gray-600"}`}
            />
            80%+ committed = 25 points (full score)
          </p>
          <p className="flex items-center gap-2 mt-1">
            <span
              className={`w-3 h-3 rounded-full ${committedPct >= 60 ? "bg-amber-500" : "bg-gray-600"}`}
            />
