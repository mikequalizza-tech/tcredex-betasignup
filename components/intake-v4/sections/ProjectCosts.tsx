...
export function ProjectCosts({ data, onChange }: ProjectCostsProps) {
  ...
  // Calculate totals
  const totalCost =
    (data.landCost || 0) + (data.constructionCost || 0) + (data.softCosts || 0);
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ totalProjectCost: parseCurrency(e.target.value) })
            }
            placeholder="0"
        ...
        <p className="text-xs text-gray-500 mt-1">
          Total all-in project cost including land, construction, and soft costs
        </p>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ landCost: parseCurrency(e.target.value) })
                }
                placeholder="0"
                className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
              />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ constructionCost: parseCurrency(e.target.value) })
                }
                placeholder="0"
                className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
              />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ softCosts: parseCurrency(e.target.value) })
                }
                placeholder="0"
                className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
              />
            ...
            <p className="text-xs text-gray-500 mt-1">
              Architecture, legal, financing fees, etc.
            </p>
          </div>
        </div>
          ...
          <div className="mt-4 p-4 bg-gray-800 rounded-lg">
            ...
            {data.totalProjectCost && Math.abs(gap) > 1 && (
              <div className="flex justify-between text-sm mt-2">
                ...
                <span
                  className={`font-medium ${gap > 0 ? "text-amber-400" : "text-red-400"}`}
                >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ financingGap: parseCurrency(e.target.value) })
              }
              placeholder="0"
              className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
          ...
          <p className="text-xs text-gray-500 mt-1">
            The financing gap that tax credit equity will help fill
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ requestedAllocation: parseCurrency(e.target.value) })
              }
              placeholder="0"
              className="w-full pl-8 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
          ...
          <p className="text-xs text-gray-500 mt-1">
            Qualified Equity Investment (QEI) amount being requested
          </p>
        </div>
      )}
    </div>
