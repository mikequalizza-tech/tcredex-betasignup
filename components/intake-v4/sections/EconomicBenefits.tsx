    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ permanentJobsFTE: parseNumber(e.target.value) })
              }
              placeholder="0"
            ...
            <div className="mt-3">
              <label className="block text-xs text-gray-400 mb-1">
                Basis for job estimate
              </label>
              <input
                type="text"
                value={data.permanentJobsBasis || ""}
                onChange={(e) =>
                  onChange({ permanentJobsBasis: e.target.value })
                }
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ constructionJobsFTE: parseNumber(e.target.value) })
              }
              placeholder="0"
              className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-2xl font-bold text-gray-100 placeholder-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-center"
            />
            ...
            <div className="mt-3">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ constructionJobsBasis: e.target.value })
                }
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  onChange({ commercialSqft: parseNumber(e.target.value) })
                }
                placeholder="0"
      ...
      <div className="border-t border-gray-800 pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) =>
                  onChange({
                    communityFacilitySqft: parseNumber(e.target.value),
                  })
                }
                placeholder="0"
                className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 pr-12"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  communityFacilityCapacity: parseNumber(e.target.value),
                })
              }
              placeholder="0"
              className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            onChange={(e) =>
              onChange({ communityFacilityBasis: e.target.value })
            }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange({ housingUnits: parseNumber(e.target.value) })
              }
              placeholder="0"
              className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange({
                  affordableHousingUnits: parseNumber(e.target.value),
                })
              }
              placeholder="0"
              className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
      ...
      <div className="border-t border-gray-800 pt-6">
        ...
        <p className="text-xs text-gray-500 mt-1">
          This is a key factor in allocation decisions - be specific about the
          financing gap
        </p>
      </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  {data.constructionJobsFTE && data.constructionJobsFTE > 0 && (
                    <span className="px-2 py-1 bg-orange-900/50 text-orange-300 rounded text-xs font-medium">
                      {data.constructionJobsFTE.toLocaleString()} Construction
                      Jobs
                    </span>
                  )}
                  ...
                  {data.affordableHousingUnits &&
                    data.affordableHousingUnits > 0 && (
