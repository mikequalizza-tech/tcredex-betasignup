    ...
    <div className="space-y-6">
      ...
      {!hasProgramSelected && (
        <div className="bg-amber-900/20 border border-amber-500/30 rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-400">
            Choose one or more tax credit programs above to unlock the remaining
            form sections.
          </p>
        </div>
      )}
      ...
      {hasProgramSelected && (
        <>
          ...
          <SectionWrapper
            id="impact"
            title="Social Investment Criteria"
            activeSection={activeSection}
          >
          ...
          <SectionWrapper
            id="costs"
            title="Project Costs & Financing Gap"
            activeSection={activeSection}
          >
          ...
          {programs.includes("NMTC") && (
            <SectionWrapper
              id="nmtc_qalicb"
              title="QALICB Eligibility Tests"
              activeSection={activeSection}
              program="NMTC"
            >
          ...
          {programs.includes("HTC") && (
            <SectionWrapper
              id="htc_status"
              title="Historic Tax Credit Details"
              activeSection={activeSection}
              program="HTC"
            >
          ...
          {programs.includes("OZ") && (
            <SectionWrapper
              id="oz_eligibility"
              title="Opportunity Zone Details"
              activeSection={activeSection}
              program="OZ"
            >
