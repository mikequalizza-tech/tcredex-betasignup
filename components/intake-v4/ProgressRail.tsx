...
const TIERS = [
  { tier: 1, name: 'DealCard Ready', minScore: 25, color: 'indigo', icon: '📋' },
  { tier: 2, name: 'Project Profile', minScore: 55, color: 'emerald', icon: '📊' },
  { tier: 3, name: 'Due Diligence Ready', minScore: 80, color: 'amber', icon: '✅' },
];
