...
interface IntakeShellProps {
  ...
  // Organization info (static, prefilled from user's org)
  organizationName?: string;
  organizationType?: string;
  sponsorData?: SponsorOrgData | null;
}
...
export function IntakeShell({
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      if (hasChanges && onSave) {
        ...
        onSave(data, readinessScore, currentTier);
      }
    };

    window.addEventListener("beforeunload", handleBeforeUnload);
    return () => window.removeEventListener("beforeunload", handleBeforeUnload);
  }, [data, hasChanges, onSave, readinessScore, currentTier]);
  ...
  const handleManualSave = useCallback(async () => {
    ...
    setSaveMessage(null);
    try {
      await onSave(data, readinessScore, currentTier);
      setHasChanges(false);
  ...
  }, [data, onSave, readinessScore, currentTier]);
  ...
  const handleFinalSubmit = useCallback(async () => {
    ...
    try {
      ...
      await onSubmit(submissionData, readinessScore, currentTier);
      setHasChanges(false);
  ...
  }, [data, onSubmit, readinessScore, currentTier, agreementChecked]);
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-700 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="px-6 py-4 border-b border-gray-800">
              <h2 className="text-xl font-bold text-gray-100">
                Platform Terms & Deal Agreement
              </h2>
              <p className="text-sm text-gray-400 mt-1">
                Please review and accept before submitting your project
              </p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-amber-200">
                      Deal Exclusivity & Fee Agreement
                    </h3>
                    <p className="text-sm text-amber-100/80 mt-1">
                      This is an important commitment. Please read carefully.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 text-sm text-gray-300">
                <p>
                  By submitting this project to tCredex, you ("Sponsor") agree
                  to the following terms:
                </p>

                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                  <h4 className="font-semibold text-gray-200 mb-2">
                    1. Platform Engagement Fee
                  </h4>
                  <p className="text-gray-400">
                    If your project receives a CDE allocation commitment, term
                    sheet, or investor capital introduction through the tCredex
                    platform while your deal is listed, a platform fee will be
                    due at closing regardless of how the final transaction is
                    ultimately structured or closed.
                  </p>
                </div>

                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                  <h4 className="font-semibold text-gray-200 mb-2">
                    2. Attribution Period
                  </h4>
                  <p className="text-gray-400">
                    This fee obligation applies to any allocation or investment
                    received from CDEs or investors with whom you were connected
                    through tCredex during the listing period, even if the deal
                    closes after you remove your listing from the platform. The
                    attribution period extends for 12 months after your last
                    active listing date.
                  </p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                  ...
                  <p className="text-gray-400">
                    You agree not to circumvent the platform by engaging
                    directly with CDEs or investors introduced through tCredex
                    outside of the platform for the purpose of avoiding platform
                    fees.
                  </p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                  <h4 className="font-semibold text-gray-200 mb-2">
                    4. CDE & Investor Independence
                  </h4>
                  <p className="text-gray-400">
                    <span className="text-green-400">Note:</span> CDEs and
                    Investors are not bound by exclusivity terms with tCredex.
                    Only Sponsors submitting projects agree to the deal
                ...
                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                  ...
                  <p className="text-gray-400">
                    Platform fees are calculated based on the allocation amount
                    and deal structure. Current fee schedules are available on
                    our{" "}
                    <a
                      href="/pricing"
                ...
                <p className="text-gray-500 text-xs">
                  ...
                  Illinois. For questions, contact{" "}
                  <a
              ...
              <div className="mt-6 p-4 bg-indigo-900/20 border border-indigo-700/50 rounded-lg">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-200">
                    I have read and agree to the tCredex Platform Terms and Deal
                    Exclusivity Agreement. I understand that platform fees apply
                    to deals closed through connections made on this platform.
                  </span>
                </label>
              </div>
            </div>
