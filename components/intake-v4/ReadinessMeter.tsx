...
export function ReadinessMeter({ data, programs, onScoreChange }: ReadinessMeterProps) {
  ...
  const { percentage: readinessScore, currentTier, tier1Pct, tier2Pct, tier3Pct } = result;
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className={tier1Pct >= 100 ? 'text-green-400' : 'text-gray-500'}>{tier1Pct}%</span>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className={tier3Pct >= 85 ? 'text-green-400' : 'text-gray-500'}>{tier3Pct}%</span>
          </div>
          <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
            <div 
