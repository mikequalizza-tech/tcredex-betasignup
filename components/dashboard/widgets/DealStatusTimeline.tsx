...
function HorizontalTimeline({ stages, currentIndex, timestamps, compact, className }: TimelineProps) {
  return (
...
function VerticalTimeline({ stages, currentIndex, timestamps, compact, className }: TimelineProps) {
  return (
          ...
          return (
            <div key={stage.id} className="relative flex gap-4">
              ...
              <div className={`pb-6 ${compact ? 'pt-1' : 'pt-0.5'}`}>
                ...
                {timestamp && (
                  <p className="text-[10px] text-gray-600 mt-1">{formatDate(timestamp)}</p>
                )}
              </div>
            </div>
          );
