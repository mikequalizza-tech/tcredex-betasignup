...
import { Bell, CheckCircle, AlertCircle, Info, ChevronRight, Check } from 'lucide-react';
...
export default function NotificationsWidget({ className = '', limit = 5 }: NotificationsWidgetProps) {
