  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800 bg-gray-900">
      <div className="flex items-center gap-2">
        {roomType === "text" && <Hash className="h-5 w-5 text-gray-400" />}
        {roomType === "audio" && <Phone className="h-5 w-5 text-green-500" />}
        {roomType === "video" && <Video className="h-5 w-5 text-indigo-500" />}
