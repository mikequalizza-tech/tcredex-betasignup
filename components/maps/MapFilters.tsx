  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        >
          <span
            className={`w-1.5 h-1.5 rounded-full ${shovelReadyOnly ? "bg-white" : "bg-green-500"}`}
          ></span>
          Shovel Ready
        </button>

        <button className="px-3 py-1.5 rounded-full text-xs font-medium bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-white border border-gray-700 transition-colors flex items-center gap-1.5">
          <svg
            className="w-3 h-3"
            fill="none"
            stroke="currentColor"
