...
export async function generateDealProfilePDF(deal: Deal, _score?: null): Promise<Blob> {
...
export async function downloadDealProfilePDF(deal: Deal, _score?: null): Promise<void> {
