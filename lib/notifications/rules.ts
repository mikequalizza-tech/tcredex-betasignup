...
export const notificationRules: NotificationRule[] = [
  ...
  // LOI-specific notifications
  {
    ...
    email: {
      ...
      preview: '{{cde_name}} is interested in funding {{project_name}}. Review and respond.',
    },
    in_app: 'New LOI from {{cde_name}} for {{project_name}} - {{allocation_amount}} offered',
    priority: 'urgent',
    auto_expire: 604800, // 7 days
  },
  {
    ...
    email: {
      ...
      preview: '{{sponsor_name}} has accepted your Letter of Intent. Move to commitment.',
    },
  ...
  },
  {
    ...
    email: {
      ...
      preview: '{{sponsor_name}} has proposed modified terms for {{project_name}}.',
    },
  ...
  },
  {
    ...
    email: {
      ...
      preview: 'Formal commitment received. Review terms and accept to proceed to closing.',
    },
  ...
  },
  {
    ...
    email: {
      ...
      preview: 'All parties have accepted. {{project_name}} is now in the closing process.',
    },
  ...
  // Project submission to CDE
  {
    ...
    email: {
      ...
      preview: '{{sponsor_name}} has submitted a project for your allocation consideration.',
    },
