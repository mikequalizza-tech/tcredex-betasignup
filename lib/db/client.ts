...
export const organizations = {
  ...
  async create(_org: Partial<DBOrganization>): Promise<DBOrganization> {
    throw new Error('Organizations are created via role tables (sponsors/cdes/investors).');
  },

  async update(_id: string, _updates: Partial<DBOrganization>): Promise<DBOrganization> {
  ...
  async getById(id: string): Promise<DBUser | null> {
    ...
    if (userData.organization_id) {
      userData.organization = {
        ...
        name: (userData as SupabaseRow).organization_name as string || 'Organization',
  ...
  async getById(id: string): Promise<DBCDE | null> {
    ...
    if (cdeData.organization_id) {
      cdeData.organization = {
        ...
        name: (cdeData as SupabaseRow).organization_name as string || 'Organization',
